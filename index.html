(function () {
  ...
  function animate(time) {
    ...
    if (animationRunning && canvas && ctx) {
      updatePhase();
      render();
    }
  ...
  // Only init animation if canvas exists (home page)
  ...
  // Sidebar + overlay (works on all pages)
  ...
  // Scroll fade (guard for elements)
  if (typeof window !== 'undefined' && toggleBtn && phaseDisplay) {
